...
--    03_core-config.sql
-- Purpose: 
--    This file stores all configuration for core schema that should not 
--    change from one implementation to the next.  These are "domain" values
--    that should exist in all implementations of the Finxact core-server.
--
...
INSERT INTO public."cntry" ("cntryName", "isoAlpha2", "isoAlpha3", "isoNumeric") VALUES 
...
('Cocos Islands -Keeling', 'CC', 'CCK', 166),
('Colombia', 'CO', 'COL', 170),
...
--
-- Data for Name: countryRegion; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public."cntryRegion" ("cntry", "region") VALUES 
('US', 'AL'),
('US', 'AK'),
('US', 'AZ'),
('US', 'AR'),
